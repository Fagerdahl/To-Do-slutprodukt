//Array declared for my List
let taskArray = [];

//Value of the counter has to be 0 in the beginning
...
function addTask() {
  ...
  if (taskText === "") {
    ...
    li.classList.add("every-specific-task"); //Making it a class for later styling
    ...
    deleteBtn.addEventListener("click", function () {
      ...
      ); /*Updating the taskArray that holds information in the form of objects.
    ...
    li.addEventListener("click", function () {
      ...
      if (taskIndex !== -1) {
        //If find-Index returns -1, there is no task in the list//If taskIndex is the opposite = +1- A task is found in the array
